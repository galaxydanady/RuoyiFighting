...
public class StuStudentController extends BaseController
{
     ...
     * 查询学生信息列表
     */
    @PreAuthorize("@ss.hasPermi('stu:stud:list')")
    @GetMapping("/list")
     ...
     * 导出学生信息列表
     */
    @PreAuthorize("@ss.hasPermi('stu:stud:export')")
     ...
     * 获取学生信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('stu:stud:query')")
     ...
     * 新增学生信息
     */
    @PreAuthorize("@ss.hasPermi('stu:stud:add')")
     ...
     * 修改学生信息
     */
    @PreAuthorize("@ss.hasPermi('stu:stud:edit')")
     ...
     * 删除学生信息
     */
    @PreAuthorize("@ss.hasPermi('stu:stud:remove')")
